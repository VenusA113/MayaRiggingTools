...
class LimbRiggerWidget(QWidget):     # commandPort -n "localhost:7001" -stp "mel"; to open for code from Python ;alt shift m to run the code in maya
    def __init__(self):
        ...
        self.masterLayout.addWidget(QLabel("Please Select the Root, Middle, and End Joint of the Limb ( Ex. Shoulder, elbow, wrist ) : ")) #HintLabel
